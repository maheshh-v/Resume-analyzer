...
export const metadata: Metadata = {
  title: "Recruit — Evidence-First Hiring Verification",
  description: "Verify what candidates claim, don't just parse it.",
};

// Runs before paint so a dark-theme user never sees a white flash.
